import { getAllPowers } from "@/core/lib/data";
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl">
                        "Heróis não nascem prontos. Eles são forjados no calor da batalha e na escolha de seus caminhos."
                    </p>
                </div>

                {/* Content */}
                <PowersList initialPowers={powers} />
            </div>
        </main>
    );
}
